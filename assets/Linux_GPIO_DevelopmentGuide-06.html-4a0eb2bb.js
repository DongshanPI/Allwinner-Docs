import{_ as e,o as i,c as n,e as l}from"./app-5cc5893e.js";const d={},s=l(`<h2 id="_6-faq" tabindex="-1"><a class="header-anchor" href="#_6-faq" aria-hidden="true">#</a> 6 FAQ</h2><h3 id="_6-1-常用-debug-方法" tabindex="-1"><a class="header-anchor" href="#_6-1-常用-debug-方法" aria-hidden="true">#</a> 6.1 常用 debug 方法</h3><h4 id="_6-1-1-利用-sunxi-dump-读写相应寄存器" tabindex="-1"><a class="header-anchor" href="#_6-1-1-利用-sunxi-dump-读写相应寄存器" aria-hidden="true">#</a> 6.1.1 利用 sunxi_dump 读写相应寄存器</h4><p>需要开启 SUNXI_DUMP 模块：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>make kernel_menuconfig
	---&gt; Device Drivers
...
config 00000001
        ...
        type: CONFIGS_GROUP controller pio group PG9 (98)config 00001409
....
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从上面的部分 log 可以看到那些设备管理的 pin 以及 pin 当前的状态是否正确。以 twi3 设备为例，twi3 管理的 pin 有 PA10/PA11，分别有两组状态 sleep 和 default，default 状态表示使用状态，sleep 状态表示 pin 处于 io disabled 状态，表示 pin 不可正常使用，twi3 设备使用的 pin 当前状态处于 sleep 状态的。</p><h4 id="_6-1-4-gpio-中断问题排查步骤" tabindex="-1"><a class="header-anchor" href="#_6-1-4-gpio-中断问题排查步骤" aria-hidden="true">#</a> 6.1.4 GPIO 中断问题排查步骤</h4><h5 id="_6-1-4-1-gpio-中断一直响应" tabindex="-1"><a class="header-anchor" href="#_6-1-4-1-gpio-中断一直响应" aria-hidden="true">#</a> 6.1.4.1 GPIO 中断一直响应</h5><ol><li><p>排查中断信号是否一直触发中断</p></li><li><p>利用 sunxi_dump 节点，确认中断 pending 位是否没有清 (参考 6.1.1 小节)</p></li><li><p>是否在 gpio 中断服务程序里对中断检测的 gpio 进行 pin mux 的切换，不允许这样切换，否则会导致中断异常</p></li></ol><h5 id="_6-1-4-2-gpio-检测不到中断" tabindex="-1"><a class="header-anchor" href="#_6-1-4-2-gpio-检测不到中断" aria-hidden="true">#</a> 6.1.4.2 GPIO 检测不到中断</h5><ol><li><p>排查中断信号是否正常，若不正常，则排查硬件，若正常，则跳到步骤 2</p></li><li><p>利用 sunxi_dump 节点，查看 gpio 中断 pending 位是否置起，若已经置起，则跳到步骤5，否则跳到步骤 3</p></li><li><p>利用 sunxi_dump 节点，查看 gpio 的中断触发方式是否配置正确，若正确，则跳到步骤 4，否则跳到步骤 5</p></li><li><p>检查中断的采样时钟，默认应该是 32k，可以通过 sunxi_dump 节点，切换 gpio 中断采样时钟到 24M 进行实验</p></li><li><p>利用 sunxi_dump，确认中断是否使能</p></li></ol>`,45),r=[s];function a(t,c){return i(),n("div",null,r)}const u=e(d,[["render",a],["__file","Linux_GPIO_DevelopmentGuide-06.html.vue"]]);export{u as default};
